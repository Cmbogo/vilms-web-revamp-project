...
export const Footer = () => {
  return (
    <footer id="contact" className="bg-sky-700 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-sky-100">
        ...
        <div className="border-t border-sky-600 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-sky-200 hover:text-pink-300 transition-colors text-sm">
                Privacy Policy
              </a>
              <a href="#" className="text-sky-200 hover:text-pink-300 transition-colors text-sm">
                Terms of Service
